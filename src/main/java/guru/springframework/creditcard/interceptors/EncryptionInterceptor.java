...
public class EncryptionInterceptor extends EmptyInterceptor {
    ...
    public boolean onSave(Object entity, Serializable id, Object[] currentState, String[] propertyNames, Type[] types) {
        ...
        Object[] newState = processFields(entity, currentState, propertyNames, "onSave");

        return super.onSave(entity, id, newState, propertyNames, types);
    }

    @Override
    public boolean onLoad(Object entity, Serializable id, Object[] currentState, String[] propertyNames, Type[] types) {
        System.out.println("I'm in onLoad");

        Object[] newState = processFields(entity, currentState, propertyNames, "onLoad");
